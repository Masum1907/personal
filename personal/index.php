...
<head>
    ...
    <style>
        ...
        width: 100%;
        height: 100vh;
        background: url(assets/img/<?=$data['wall1']?>) top center;
...
<body>
    ...
    <header id="header">
      ...
      if($data['instagram']!=""){
       ...
       if($data['skype']!=""){
            ?>
                    <a href="<?=$data['skype']?>" class="google-plus"><i class="bx bxl-youtube"></i></a>
                    <?php
        }
      if($data['linkedin']!=""){
            ?>
      ...
      if($data['github']!=""){
        ...
        ?>
            ...
            <nav class="nav-menu">
                <ul>
                    <li class=""><a href="#home"><i class="bx bx-home"></i> <span>Home</span></a></li>
                    <li><a href="#about"><i class="bx bx-user"></i> <span>About</span></a></li>
                    <li><a href="#resume"><i class="bx bx-file-blank"></i> <span>Resume</span></a></li>
                    <li><a href="#portfolio"><i class="bx bx-book-content"></i> Portfolio</a></li>
                    <li><a href="#contact"><i class="bx bx-envelope"></i> Contact</a></li>
                    <li><a href="admin/index.php"><i class="bx bx-file-blank"></i> <span>Admin</span></a></li>
                    <li ><a class="blinking-text" href="https://drive.google.com/drive/folders/1X3dFsTiqwDk2YR2NB741q_Pi0iDkcnAH?fbclid=IwAR1MAwKpjnkE1mxf-EHLrggktWQv7dJ3LyHMrStgGh_ezrfSTVtE8qPO27c" ><span> <i class="fas fa-download"></i>Download CV</span></a>
        </li>
                </ul>
            </nav><!-- .nav-menu -->
            <button type="button" class="mobile-nav-toggle d-xl-none"><i class="icofont-navigation-menu"></i></button>
    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="row">
                        <img src="assets/img/<?=$data['wall3']?>" class="img-fluid" alt="">
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6" data-aos="fade-up">
                ...
                <?php
                $query_education = "SELECT * FROM resume WHERE category='e' ORDER BY CASE WHEN title = 'B.Sc. in CSE' THEN 1 WHEN title = 'HSC' THEN 2 WHEN title = 'SSC' THEN 3 ELSE 4 END, STR_TO_DATE(year, '%Y') DESC";
                $runquery_education = mysqli_query($db, $query_education);

                while ($data_education = mysqli_fetch_array($runquery_education)) {
                    ?>
                    <div class="resume-item">
                        <h4><?= $data_education['title'] ?></h4>
                        <h5><?= $data_education['year'] ?></h5>
                        <p><em><?= $data_education['ogname'] ?></em></p>
                        <p><?= $data_education['workdesc'] ?></p>
                    </div>
                <?php
                }
                ?>
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                ...
                <?php
                $query_experience = "SELECT * FROM resume WHERE category='pe' ORDER BY STR_TO_DATE(year, '%Y') DESC";
                $runquery_experience = mysqli_query($db, $query_experience);

                while ($data_experience = mysqli_fetch_array($runquery_experience)) {
                    ?>
                    <div class="resume-item">
                        <h4><?= $data_experience['title'] ?></h4>
                        <h5><?= $data_experience['year'] ?></h5>
                        <p><em><?= $data_experience['ogname'] ?></em></p>
                        <p><?= $data_experience['workdesc'] ?></p>
                    </div>
                <?php
                }
                ?>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links" title="<?= $data5['projectname'] ?>">
                            ...
                            <!-- Update the onclick event to trigger JavaScript function -->
                            <button class="show-details-btn" onclick="showDetails('<?= $data5['projectname'] ?>', '<?= $data5['projectlink'] ?>', '<?= $data5['projectpic'] ?>', '<?= $data5['details'] ?>')">Details</i></button>
                        </div>
                    </div>
                </div>
            <?php
...
<div id="project-modal" class="modal">
    <!-- Container to display project details -->
    <div id="project-details-content" class="modal-content">
        <span class="close-btn" onclick="closeDetails()">&times;</span>
    </div>
</div>

<!-- JavaScript for displaying and hiding project details -->
<script>
    function showDetails(projectName, projectLink, projectPic, projectDetails) {
        // Replace the content of the modal with the fetched details
        document.getElementById('project-details-content').innerHTML = `
            <div id="project-details-container">
                ...
                <img src="assets/img/${projectPic}" alt="${projectName}" style="max-width: 100%; max-height:50%;">
