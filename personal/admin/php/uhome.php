...
if(isset($_POST['save'])){
    ...
    $wall2=$_FILES['wall2']['name'];
    $wall3=$_FILES['wall3']['name'];
    
$w2done = ""; // initialize to default value
$w3done = ""; // initialize to default value
...
if($wall2==""){
    ...
    $w2done = Upload('wall2', $target_dir);
}

if($wall3==""){
    $wall3=$data['wall3'];
} else {
    $w3done = Upload('wall3', $target_dir);
}
...
$query.="github='$github',";
$query.="wall1='$homewallpaper',";
$query.="professions='$profession',";
$query.="location='$address',";
$query.="mobile='$mobile',";
$query.="emailid='$email',";
$query.="wall2='$wall2',";
$query.="wall3='$wall3'WHERE 1";
